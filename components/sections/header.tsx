  ...
  return (
    <div className="relative flex font-mono w-screen h-screen text-white">
      <div className="w-full items-center absolute left-0 top-60 pl-5 md:pl-32 py-16 text-left bg-white text-black">
        <p className="font-bold text-pink text-[calc(8vw)] md:text-[calc(5vw)] uppercase tracking-widest">
          Brianna Duvivier
        </p>
        <p className="text-[calc(2.5vw)] md:text-[calc(1.5vw)] mb-4">
          Full Stack Developer, creative technologist and
          <br />
          dog enthusiast
        </p>

        <div className="flex flex-row justify-start gap-4 my-3">
          <a
      ...
      <Image
        className="absolute top-96 w-[calc(60vw)] md:top-72 lg:top-60 right-0 md:w-[calc(45vw)] h-auto justify-end"
